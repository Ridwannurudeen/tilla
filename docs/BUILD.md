...
3. **MPP pay-as-you-go — LIVE, HALF-PROVEN.** Enabled, and one channel has been **opened with a signed voucher** against a 2 USDT deposit. It has **never been closed or settled** — the close half of the loop is unproven and is not claimed anywhere.
